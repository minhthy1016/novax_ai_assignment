...
| T7.4 | Metrics: requests, errors, latency, model calls, tool calls, retrieval timing | `metrics.py`: HTTP + model calls/latency/tokens wired; tool + retrieval defined | `test_metrics_use_route_templates` | 🟡 tool/retrieval wiring days 3-4 |
