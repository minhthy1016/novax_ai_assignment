...
| T2.4 | Justify chunk size, overlap, embedding model, metadata schema, top-K, reranking | architecture.md D-20, D-21 | `evaluation/chunking_eval.py` (8 strategies incl. Docling, report `evaluation/reports/chunking.md`), `evaluation/relevance_calibration.py`, `evaluation/retrieval_api_eval.py` (live API: R@1 0.941, R@3 1.000, MRR 0.961) | ✅ |
